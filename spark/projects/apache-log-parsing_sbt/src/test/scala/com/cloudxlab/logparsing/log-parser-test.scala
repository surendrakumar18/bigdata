...
class LogParserSpec extends FlatSpec {
  ...
  "containsIP" should "Check if IP exists in the log line" in {
    ...
    assert(!utils.containsIP(line2))
     ...
     "parseLogLine" should "Parse log line in" in {
    val utils = new Utils
    var line = "slppp6.intermind.net - - [01/Aug/1995:00:00:12 -0400] \"GET /images/ksclogosmall.gif HTTP/1.0\" 200 3635"
    //var line1 = "121.242.40.10 - - [03/Aug/2015:06:30:52 -0400] \"POST /mod_pagespeed_beacon?url=http%3A%2F%2Fwww.knowbigdata.com%2Fpage%2Fabout-us HTTP/1.1\" 204 206 \"http://www.knowbigdata.com/page/about-us\" \"Mozilla/5.0 (Windows NT 6.3; WOW64; rv:39.0) Gecko/20100101 Firefox/39.0\""
    var url = utils.parseLogLine(line)
    assert(url == "/images/ksclogosmall.gif")
  }
   
          "parseLogLine2" should "Parse log line for timestamp" in {
    val utils = new Utils
    var line = "slppp6.intermind.net - - [01/Aug/1995:00:00:12 -0400] \"GET /images/ksclogosmall.gif HTTP/1.0\" 200 3635"
    //var line1 = "121.242.40.10 - - [03/Aug/2015:06:30:52 -0400] \"POST /mod_pagespeed_beacon?url=http%3A%2F%2Fwww.knowbigdata.com%2Fpage%2Fabout-us HTTP/1.1\" 204 206 \"http://www.knowbigdata.com/page/about-us\" \"Mozilla/5.0 (Windows NT 6.3; WOW64; rv:39.0) Gecko/20100101 Firefox/39.0\""
    var url = utils.parseLogLine2(line)
    assert(url == "01/Aug/1995:00:00:12 -0400")
  }
          
     "parseLogLine3" should "Parse log line for HTTP code" in {
    val utils = new Utils
    var line = "slppp6.intermind.net - - [01/Aug/1995:00:00:12 -0400] \"GET /images/ksclogosmall.gif HTTP/1.0\" 200 3635"
    //var line1 = "121.242.40.10 - - [03/Aug/2015:06:30:52 -0400] \"POST /mod_pagespeed_beacon?url=http%3A%2F%2Fwww.knowbigdata.com%2Fpage%2Fabout-us HTTP/1.1\" 204 206 \"http://www.knowbigdata.com/page/about-us\" \"Mozilla/5.0 (Windows NT 6.3; WOW64; rv:39.0) Gecko/20100101 Firefox/39.0\""
    var url = utils.parseLogLine3(line)
    assert(url == "200")
  }
